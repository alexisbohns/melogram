<script lang="ts">
	...
	export let controls: string[] = ['play', 'progress', 'current-time', 'mute', 'volume'];
...
<svelte:head>
	...
	<script src="https://cdn.jsdelivr.net/npm/plyr@3.7.8/dist/plyr.polyfilled.min.js" defer></script>
	<style>
		.plyr--audio {
			max-width: 100%;
		}
...
{#if src}
	<audio bind:this={audioEl} controls playsinline {preload} {src}></audio>
{:else}
