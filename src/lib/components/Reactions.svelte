...
<div class="reactions">
	<button on:click={() => vote('love')} class="reactions-item">
		<Icon
			icon={clicked.love ? icons.heart : icons.heartRegular}
			size={16}
			label={$t('common.love')}
		/>
	...
	<button on:click={() => vote('thumbs_up')} class="reactions-item">
		<Icon
			icon={clicked.thumbs_up ? icons.thumbsUp : icons.thumbsUpRegular}
			size={16}
			label={$t('common.love')}
		/>
	...
	<button on:click={() => vote('neutral')} class="reactions-item">
		<Icon
			icon={clicked.neutral ? icons.squareMinus : icons.squareMinusRegular}
			size={16}
